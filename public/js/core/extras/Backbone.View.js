...
(function () {
    ...
    _.extend(Backbone.View.prototype, {
        ...
        , confirm: function (ttype, options) {
            return this.options.application && this.options.application.getLayout().confirm(ttype, options);
        }

        , alert: function (options) {
            return this.options.application && this.options.application.getLayout().alert(options);
        }
        ...
        , showConfirmationMessage: function (message) {
            var $msg_el = jQuery(SPA.macros.message(message, 'success', true))
        ...
        , showWarningMessage: function (message) {
            var $msg_el = jQuery(SPA.macros.message(message, 'warning', true));
