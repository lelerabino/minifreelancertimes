...
define(['Application', 'jasmineTypeCheck'], function ()
{
	...
	describe('Application.Layout', function ()
	{
		it('Init', function ()
		{
			SPA.templates = {'layout_tmpl': '<div id="layout"><div class="site-header"></div><div id="content"></div><div class="site-footer"></div></div>'};
			...
			application = SPA.Application('Applicaiton.Layout.test1');
		...
		it('#should trigger beforeAppendView, beforeRender, afterAppendView and afterRender events', function ()
		{
			...
			SPA.templates.layouttest1_tmpl = '<p>hello world</p>';
